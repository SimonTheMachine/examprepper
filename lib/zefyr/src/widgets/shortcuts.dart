...
class ToggleSubScriptStyleIntent extends Intent {
  const ToggleSubScriptStyleIntent();
}

class ToggleSuperScriptStyleIntent extends Intent {
  const ToggleSuperScriptStyleIntent();
}
...
class ZefyrActions extends Actions {
  ...
  static final Map<Type, Action<Intent>> _shortcutsActions =
    ...
    ToggleSubScriptStyleIntent:
        _ToggleInlineStyleAction(NotusAttribute.subScript),
    ToggleSuperScriptStyleIntent:
        _ToggleInlineStyleAction(NotusAttribute.superScript),
    ToggleUnderlineStyleIntent:
