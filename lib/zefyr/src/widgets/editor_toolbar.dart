...
class ZefyrToolbar extends StatefulWidget implements PreferredSizeWidget {
  ...
  factory ZefyrToolbar.basic({
    ...
    bool hideSubScript = false,
    bool hideSuperScript = false,
    ...
    return ZefyrToolbar(key: key, children: [
      ...
      const SizedBox(width: 1),
      Visibility(
        visible: !hideSubScript,
        child: ToggleStyleButton(
          attribute: NotusAttribute.subScript,
      ...
      const SizedBox(width: 1),
      Visibility(
        visible: !hideSuperScript,
        child: ToggleStyleButton(
          attribute: NotusAttribute.superScript,
