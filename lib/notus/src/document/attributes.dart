...
///
///   * [NotusAttribute.bold]
///   * [NotusAttribute.subScript]
///   * [NotusAttribute.superScript]
...
class NotusAttribute<T> implements NotusAttributeBuilder<T> {
  static final Map<String, NotusAttributeBuilder> _registry = {
    ...
    //MY ATTRIBUTE
    NotusAttribute.subScript.key: NotusAttribute.subScript,
    NotusAttribute.superScript.key: NotusAttribute.superScript,
  };

  // Inline attributes

  //MY ATTRIBUTE
  static const subScript = _SubScriptAttribute();

  static const superScript = _SuperScriptAttribute();
...
class _InlineCodeAttribute extends NotusAttribute<bool> {
  const _InlineCodeAttribute() : super._('j', NotusAttributeScope.inline, true);
}

/// Applies code style to a text segment.
//MY ATTRIBUTE:

class _SubScriptAttribute extends NotusAttribute<bool> {
  const _SubScriptAttribute() : super._('g', NotusAttributeScope.inline, true);
}

class _SuperScriptAttribute extends NotusAttribute<bool> {
  const _SuperScriptAttribute()
