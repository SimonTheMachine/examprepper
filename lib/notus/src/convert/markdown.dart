...
class _NotusMarkdownEncoder extends Converter<Delta, String> {
  ...
  void _writeAttribute(StringBuffer buffer, NotusAttribute? attribute,
    ...
    } else if (attribute?.key == NotusAttribute.subScript.key) {
      _writeSuperScriptTag(buffer);
  ...
  void _writeSuperScriptTag(StringBuffer buffer) {
    //TODO: SUPERSCRIPT IS MORE COMPLICATED THAN ANTICIPATED.
    buffer.write(kItalic);
  }
